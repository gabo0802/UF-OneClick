...
func TestChangeTimezone(t *testing.T) {
	...
	// Checks if the timezone was updated
...
func TestNewUser(t *testing.T) {
	...
	// Checks that the user was actually created in the database
	var count int
...
func TestGetAllSubscriptionServices(t *testing.T) {
	...
	// Check the response body for success or error messages
...
func TestDeleteUser(t *testing.T) {
	...
	// Set the current user ID to 1 for testing
	currentID = 1
